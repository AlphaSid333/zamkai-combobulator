...
$elevate_experience_text = esc_html__( 'Elevate Your Learning Experience', 'online-courses-fse' );
$transform_career_text   = esc_html__( 'Transform your career with structured learning paths designed by industry professionals.', 'online-courses-fse' );

$learn_anytime_title_text = esc_html__( 'Learn Anytime', 'online-courses-fse' );
$learn_anytime_desc_text  = esc_html__( 'Study whenever you want. All course videos &amp; materials are available 24/7.', 'online-courses-fse' );

$expert_teachers_title_text = esc_html__( 'Expert Teachers', 'online-courses-fse' );
$expert_teachers_desc_text  = esc_html__( 'Learn from experienced instructors who know their subjects inside out.', 'online-courses-fse' );

$smart_progress_title_text = esc_html__( 'Smart Progress Tracking', 'online-courses-fse' );
$smart_progress_desc_text  = esc_html__( 'Know what you\'ve finished and what\'s coming next.', 'online-courses-fse' );

$flexible_paths_title_text = esc_html__( 'Flexible Learning Paths', 'online-courses-fse' );
$flexible_paths_desc_text  = esc_html__( 'Study at your own pace and choose your schedule.', 'online-courses-fse' );

$complete_lessons_title_text = esc_html__( 'Complete Lessons', 'online-courses-fse' );
$complete_lessons_desc_text  = esc_html__( 'Everything you need to learn is included. Basics to advanced topics.', 'online-courses-fse' );

$get_certified_title_text = esc_html__( 'Get Certified', 'online-courses-fse' );
$get_certified_desc_text  = esc_html__( 'Receive a certificate when you complete a course.', 'online-courses-fse' );
...
<h2 class="wp-block-heading has-text-align-center" style="text-transform:capitalize">' . $elevate_experience_text . '</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">' . $transform_career_text . '</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<h4 class="wp-block-heading has-text-align-left" style="text-transform:capitalize">' . $learn_anytime_title_text . '</h4>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"left","style":{"typography":{"fontSize":"17px"}}} -->
<p class="has-text-align-left" style="font-size:17px">' . $learn_anytime_desc_text . '</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"6px"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"left","verticalAlignment":"center"}} -->
<div class="wp-block-group"><!-- wp:heading {"textAlign":"left","level":4,"style":{"typography":{"textTransform":"capitalize"}}} -->
<h4 class="wp-block-heading has-text-align-left" style="text-transform:capitalize">' . $expert_teachers_title_text . '</h4>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"left","style":{"typography":{"fontSize":"17px"}}} -->
<p class="has-text-align-left" style="font-size:17px">' . $expert_teachers_desc_text . '</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"6px"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"left","verticalAlignment":"center"}} -->
<div class="wp-block-group"><!-- wp:heading {"textAlign":"left","level":4,"style":{"typography":{"textTransform":"capitalize"}}} -->
<h4 class="wp-block-heading has-text-align-left" style="text-transform:capitalize">' . $smart_progress_title_text . '</h4>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"left","style":{"typography":{"fontSize":"17px"}}} -->
<p class="has-text-align-left" style="font-size:17px">' . $smart_progress_desc_text . '</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
...
<!-- wp:group {"style":{"spacing":{"blockGap":"6px"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"left","verticalAlignment":"center"}} -->
<div class="wp-block-group"><!-- wp:heading {"textAlign":"left","level":4,"style":{"typography":{"textTransform":"capitalize"}}} -->
<h4 class="wp-block-heading has-text-align-left" style="text-transform:capitalize">' . $flexible_paths_title_text . '</h4>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"left","style":{"typography":{"fontSize":"17px"}}} -->
<p class="has-text-align-left" style="font-size:17px">' . $flexible_paths_desc_text . '</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"6px"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"left","verticalAlignment":"center"}} -->
<div class="wp-block-group"><!-- wp:heading {"textAlign":"left","level":4,"style":{"typography":{"textTransform":"capitalize"}}} -->
<h4 class="wp-block-heading has-text-align-left" style="text-transform:capitalize">' . $complete_lessons_title_text . '</h4>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"left","style":{"typography":{"fontSize":"17px"}}} -->
<p class="has-text-align-left" style="font-size:17px">' . $complete_lessons_desc_text . '</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"6px"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"left","verticalAlignment":"center"}} -->
<div class="wp-block-group"><!-- wp:heading {"textAlign":"left","level":4,"style":{"typography":{"textTransform":"capitalize"}}} -->
<h4 class="wp-block-heading has-text-align-left" style="text-transform:capitalize">' . $get_certified_title_text . '</h4>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"left","style":{"typography":{"fontSize":"17px"}}} -->
<p class="has-text-align-left" style="font-size:17px">' . $get_certified_desc_text . '</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
