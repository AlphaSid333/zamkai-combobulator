...
$description_text = esc_html__( 'Join 750+ students who are learning new skills and building better careers.', 'online-courses-fse' );
...
<p class="has-button-1-color has-text-color has-link-color">' . $description_text . '</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
