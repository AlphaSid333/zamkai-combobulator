...
$main_heading_text = esc_html__( 'Where Knowledge Meets Innovation', 'online-courses-fse' );
$description_text  = esc_html__( 'Discover our most enrolled and top-rated classes. Learn skills that students trust and employers value.', 'online-courses-fse' );

$our_mission_title_text = esc_html__( 'Our Mission', 'online-courses-fse' );
$our_mission_desc_text  = esc_html__( 'I took the Website Development course and got my dream job in 6 months. It really helped me.', 'online-courses-fse' );

$our_techniques_title_text = esc_html__( 'Our Techniques', 'online-courses-fse' );
$our_techniques_desc_text  = esc_html__( 'To empower learners worldwide by providing accessible, engaging, and high-quality education that inspires growth, innovation, and lifelong learning', 'online-courses-fse' );

$our_purpose_title_text = esc_html__( 'Our Purpose', 'online-courses-fse' );
$our_purpose_desc_text  = esc_html__( 'We want to inspire people to keep learning and improving. Our purpose is to help everyone find their path and move forward with confidence.', 'online-courses-fse' );
...
<p class="has-text-align-center has-text-color" style="font-size:19px;line-height:1.84">' . $description_text . '</p>
<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
	</div>
...
<div class="wp-block-group"><!-- wp:heading {"textAlign":"left","level":4,"style":{"typography":{"fontSize":"20px","fontStyle":"normal","fontWeight":"700","lineHeight":"1.6","textTransform":"capitalize"}},"fontFamily":"manrope"} -->
<h4 class="wp-block-heading has-text-align-left has-manrope-font-family" style="font-size:20px;font-style:normal;font-weight:700;line-height:1.6;text-transform:capitalize">
							' . $our_techniques_title_text . '
						</h4>
						<!-- /wp:heading -->

						<!-- wp:paragraph {"align":"left","style":{"elements":{"link":{"color":{"text":"var:preset|color|paragraph"}}},"typography":{"fontSize":"17px","lineHeight":"1.82"}},"textColor":"paragraph"} -->
<p class="has-text-align-left has-paragraph-color has-text-color has-link-color" style="font-size:17px;line-height:1.82">
							' . $our_techniques_desc_text . '
						</p>
						<!-- /wp:paragraph -->
					</div>
					<!-- /wp:group -->
...
<div class="wp-block-group"><!-- wp:heading {"textAlign":"left","level":4,"style":{"typography":{"fontSize":"20px","fontStyle":"normal","fontWeight":"700","lineHeight":"1.6","textTransform":"capitalize"}},"fontFamily":"manrope"} -->
<h4 class="wp-block-heading has-text-align-left has-manrope-font-family" style="font-size:20px;font-style:normal;font-weight:700;line-height:1.6;text-transform:capitalize">
							' . $our_purpose_title_text . '
						</h4>
						<!-- /wp:heading -->

						<!-- wp:paragraph {"align":"left","style":{"elements":{"link":{"color":{"text":"var:preset|color|paragraph"}}},"typography":{"fontSize":"17px","lineHeight":"1.82"}},"textColor":"paragraph"} -->
<p class="has-text-align-left has-paragraph-color has-text-color has-link-color" style="font-size:17px;line-height:1.82">
							' . $our_purpose_desc_text . '
						</p>
						<!-- /wp:paragraph -->
					</div>
					<!-- /wp:group -->
