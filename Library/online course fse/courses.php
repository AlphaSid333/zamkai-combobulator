...
$description_text     = esc_html__( 'Check out our most loved courses that help students succeed.', 'online-courses-fse' );
...
$price_95_text       = esc_html__( '$95', 'online-courses-fse' );
$view_course_text    = esc_html__( 'View Course', 'online-courses-fse' );

$website_development_text = esc_html__( 'Website Development', 'online-courses-fse' );
$price_120_text           = esc_html__( '$120', 'online-courses-fse' );

$digital_marketing_text = esc_html__( 'Digital Marketing Basics', 'online-courses-fse' );
$price_89_text          = esc_html__( '$89', 'online-courses-fse' );
...
<p class="has-text-align-left has-accent-3-color has-text-color has-regular-font-size">' . $description_text . '&nbsp;</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<h4 class="wp-block-heading has-heading-color has-text-color has-manrope-font-family has-extra-large-font-size">' . $graphic_design_text . '</h4>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<h4 class="wp-block-heading has-heading-color has-text-color has-extra-large-font-size" style="letter-spacing:0.16px">' . $price_95_text . '</h4>
<!-- /wp:heading -->
...
<!-- wp:group {"style":{"spacing":{"padding":{"top":"0px"}},"border":{"top":{"style":"none","width":"0px"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group" style="border-top-style:none;border-top-width:0px;padding-top:0px"><!-- wp:heading {"level":4,"textColor":"heading","fontSize":"extra-large","fontFamily":"manrope"} -->
<h4 class="wp-block-heading has-heading-color has-text-color has-manrope-font-family has-extra-large-font-size">' . $website_development_text . '</h4>
<!-- /wp:heading --></div>
<!-- /wp:group -->

<!-- wp:group {"style":{"spacing":{"padding":{"top":"20px"}},"border":{"top":{"color":"#d3d3d3","width":"1px"}}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between"}} -->
<div class="wp-block-group" style="border-top-color:#d3d3d3;border-top-width:1px;padding-top:20px"><!-- wp:heading {"level":4,"style":{"typography":{"letterSpacing":"0.16px"}},"textColor":"heading","fontSize":"extra-large"} -->
<h4 class="wp-block-heading has-heading-color has-text-color has-extra-large-font-size" style="letter-spacing:0.16px">' . $price_120_text . '</h4>
<!-- /wp:heading -->
...
<!-- wp:group {"style":{"spacing":{"padding":{"top":"0px"}},"border":{"top":{"style":"none","width":"0px"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group" style="border-top-style:none;border-top-width:0px;padding-top:0px"><!-- wp:heading {"level":4,"textColor":"heading","fontSize":"extra-large","fontFamily":"manrope"} -->
<h4 class="wp-block-heading has-heading-color has-text-color has-manrope-font-family has-extra-large-font-size">' . $digital_marketing_text . '</h4>
<!-- /wp:heading --></div>
<!-- /wp:group -->

<!-- wp:group {"style":{"spacing":{"padding":{"top":"20px"}},"border":{"top":{"color":"#d3d3d3","width":"1px"}}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between"}} -->
<div class="wp-block-group" style="border-top-color:#d3d3d3;border-top-width:1px;padding-top:20px"><!-- wp:heading {"level":4,"style":{"typography":{"letterSpacing":"0.16px"}},"textColor":"heading","fontSize":"extra-large"} -->
<h4 class="wp-block-heading has-heading-color has-text-color has-extra-large-font-size" style="letter-spacing:0.16px">' . $price_89_text . '</h4>
<!-- /wp:heading -->
