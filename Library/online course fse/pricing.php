...
$choose_plan_text    = esc_html__( 'Choose a plan that works for you.', 'online-courses-fse' );

$single_course_title_text = esc_html__( 'Simple Pricing', 'online-courses-fse' );
$single_course_desc_text  = esc_html__( 'Choose a plan that works for you.', 'online-courses-fse' );

$feature_access_lessons_text = esc_html__( 'Access to all lessons', 'online-courses-fse' );
$feature_certificate_text    = esc_html__( 'Get a certificate', 'online-courses-fse' );
$feature_email_support_text  = esc_html__( 'Email support for 6 months', 'online-courses-fse' );
$feature_community_text      = esc_html__( 'Join our student community', 'online-courses-fse' );

$single_price_text   = esc_html__( '$100.0', 'online-courses-fse' );
$per_month_text      = esc_html__( '/mo', 'online-courses-fse' );
$start_learning_text = esc_html__( 'Start Learning', 'online-courses-fse' );

$bundle_title_text = esc_html__( 'Course Bundle', 'online-courses-fse' );
$bundle_desc_text  = esc_html__( 'For groups and organizations. Everything in single course, plus:', 'online-courses-fse' );

$feature_take_courses_text  = esc_html__( 'Take 5 courses', 'online-courses-fse' );
$feature_extra_support_text = esc_html__( 'Extra support from teachers', 'online-courses-fse' );
$feature_career_advice_text = esc_html__( 'Career advice session', 'online-courses-fse' );
$feature_one_year_text      = esc_html__( '1 year access', 'online-courses-fse' );

$bundle_price_text = esc_html__( '$250.0', 'online-courses-fse' );
...
<h5 class="wp-block-heading has-text-align-left" style="font-size:26px;font-style:normal;font-weight:700;line-height:1.46">
						<strong>' . $single_course_title_text . '</strong>
					</h5>
					<!-- /wp:heading -->
...
<div class="wp-block-group"><!-- wp:heading {"textAlign":"left","level":5,"style":{"typography":{"fontSize":"26px","fontStyle":"normal","fontWeight":"700","lineHeight":"1.46"}}} -->
<h5 class="wp-block-heading has-text-align-left" style="font-size:26px;font-style:normal;font-weight:700;line-height:1.46">
						<strong><strong>' . $bundle_title_text . '</strong></strong>
					</h5>
					<!-- /wp:heading -->
