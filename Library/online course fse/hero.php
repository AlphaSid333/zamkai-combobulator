...
$rating_text             = esc_html__( '4.8/5', 'online-courses-fse' );
$main_heading_text       = esc_html__( 'Where Learning Meets Real World Growth', 'online-courses-fse' );
$highlighted_growth_text = esc_html__( 'Growth', 'online-courses-fse' );
$description_text        = esc_html__( 'Quality education designed to equip you with practical skills and industry-ready knowledge through our expertly crafted curriculum.', 'online-courses-fse' );
...
<h4 class="wp-block-heading has-text-align-left">' . $rating_text . '</h4>
<!-- /wp:heading -->
...
<h1 class="wp-block-heading">' . $main_heading_text . ' <mark style="background-color:rgba(0, 0, 0, 0);color:var(--wp--preset--color--primary)" class="has-inline-color">' . $highlighted_growth_text . '</mark></h1>
<!-- /wp:heading -->
